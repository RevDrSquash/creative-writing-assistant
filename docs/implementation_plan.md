...
* Default Model Configs: Support default model configuration roles (originally small/standard/large;
  later replaced by requirement-based roles — orchestration, writing, judgment, structure — see
