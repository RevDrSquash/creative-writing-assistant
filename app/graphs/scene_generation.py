...
def run_scene_generation(scene_id: str, *, max_revisions: int = 1) -> None:
    ...
    start_event_id, end_event_id = scene_event_window(world.story_bible, blueprint.event_ids)
    ...
    workflow.invoke(
        {
            ...
            "scene_start_event_id": start_event_id,
            "scene_end_event_id": end_event_id,
            "constraints": blueprint.constraints,
            "starting_state": blueprint.starting_state,
            "central_conflict": blueprint.central_conflict,
            "required_resolution": blueprint.required_resolution,
